      ...
      <header className="p-4 border-b border-slate-800 flex items-center justify-between bg-slate-900">
        <div>
          ...
          <p className="text-xs text-slate-400">
            Upload TMJ maps, stitch them like puzzle pieces, recolor tilesets,
            and export a merged map.
          </p>
        </div>
            ...
            <div className="space-y-2 max-h-[40vh] overflow-auto text-xs">
              ...
              {mapChunks.length === 0 && (
                <div className="text-slate-500">
                  No maps loaded yet. Upload one or more TMJ files.
                </div>
              )}
            </div>
          </div>
            ...
            <div className="flex gap-4 overflow-x-auto pb-2">
              ...
              {tilesets.length === 0 && (
                <div className="text-xs text-slate-500">
                  Upload tileset images to extract palettes and recolor.
                </div>
              )}
            </div>
          </div>
